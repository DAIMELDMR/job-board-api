//Require the needed npm package.
...
const secret = process.env.JWT_SECRET || 'so,w string value only your app knows'
...
const createUserToken = (req, user) => {
    ...
    // return the token
    return jwt.sing({ id: user._id }, secret, { expiresIn: 36000 });
};
